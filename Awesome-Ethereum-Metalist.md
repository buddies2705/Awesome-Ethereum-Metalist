...
We have created a list of all the curated resource list in Ethereum. Let’s us know in comments if we missed something. 
> # “The blockchain symbolizes a shift in power from the centers to the edges of the networks.” — William Mougayar

### Awesome-List Cryptoeconomics
...
Resource list —  A[wesome-Cryptoeconomics](https://github.com/jpantunes/awesome-cryptoeconomics)
...
[A curated list of cryptography papers, articles, tutorials, and how-tos. ](https://github.com/pFarb/awesome-crypto-papers)
...
* [Awesome state channels](https://github.com/machinomy/awesome-state-channels)

### A list of protocols for decentralized exchange

A curated list of different Decentralized exchange projects and protocols. 

Resource list

* [Dex protocols](https://github.com/evbots/dex-protocols)
...
* [Ethereum-token-standards-list](https://github.com/PhABC/ethereum-token-standards-list)
...
* [Ethereum reading List](https://github.com/Scanate/EthList/blob/master/README.md)
...
* [Awesome ethereum analytics](https://github.com/jdourlens/awesome-ethereum-analytics)
...
* [Ethhub.io](https://docs.ethhub.io/ethereum-basics/resources)

### Sharding roadmap

Ethereum is moving to Proof of stake system which will also include scaling solutions such as sharding. 
...
An accomplice to the [Consensys “Smart Contract Best Practices”](https://consensys.github.io/smart-contract-best-practices/), but with less security and more engineering focus. 
...
* [The Ethereum Community Fund (ECF)](/other/funds/ecf)`

* [ETH Prize](https://github.com/ethhub-io/ethhub/tree/b3773ad3f168701b75d1c56e8fb2a92409e8952f/other/funds/eth-prize.md)

* [Status Incubate](/other/funds/status-incubate) by Status.im

* [Aragon Nest](/other/funds/aragon-nest) by aragon

* [0x Ecosystem Acceleration Program](/other/funds/0xeap) by 0xProject

* [The Stable Fund](/other/funds/stable-fund) by MakerDAO

* [ConsenSys Ventures](/other/funds/consensys-vc) by ConsenSys

* [ConsenSys labs](/other/funds/consensys-labs) by ConsenSys

* [Gnosis X](/other/funds/gnosisx) by Gnosis
